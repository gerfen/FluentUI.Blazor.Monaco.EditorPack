...
namespace FluentUI.Blazor.Monaco.EditorPack.DemoApp.Components.Cookies;

public class CookieConsentService(IJSRuntime jsRuntime) : JSModule(jsRuntime, "./js/CookieConsent.js")
{
